...
margins = { top: 50, left: 80, right: 20, bottom: 150 }
...
titulo = g.append('text')
          ...
          .text('Casos Covid19 en América Latina')
...
// IV. Carga de datos
d3.csv('20210207covidLatinoAmerica.csv')
.then(function(data) {
  data.forEach(d => {
...
function frame() {
  ...
  y.domain([0, maxy])
  x.domain(dataframe.map(d => d.combined_key))
